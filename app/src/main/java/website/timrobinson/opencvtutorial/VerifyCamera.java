...
public class VerifyCamera extends AppCompatActivity implements OnTouchListener, CvCameraViewListener2 {
        ...
        public void onManagerConnected(int status) {
            switch (status) {
                case LoaderCallbackInterface.SUCCESS: {
                    ...
                    mOpenCvCameraView.setOnTouchListener(VerifyCamera.this);
                }
                break;
                default: {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        Toast.makeText(getApplicationContext(),"COLOR : " + getColorName((int) mBlobColorRgba.val[0],
                (int)mBlobColorRgba.val[1],
                (int)mBlobColorRgba.val[2]),0).show();
    ...
    private String getColorName(int r,int g, int b){
        ...
        checkCompleted(colorUtils.getColorNameFromColor(r,g,b));

        return colorUtils.getColorNameFromColor(r,g,b);
